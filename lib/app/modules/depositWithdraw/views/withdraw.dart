...
class WithdrawView extends GetView<DepositController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Withdraw Request'), centerTitle: true),
      body: FutureBuilder(
        future: withdraw.where('approved', isEqualTo: false).get(),
          ...
          return Obx(() {
            return Padding(
              ...
              child: ListView.builder(
                itemCount: depositController.withdrawTransition.length,
                itemBuilder: (context, index) {
                  final assetPath =
                      depositController.withdrawTransition[index]['company'];
                  final id = data!.docs[index].id;

                  final wallet =
                      depositController.withdrawTransition[index]['walletName']
                          .toString()
                          .toLowerCase();

                  final phone =
                      depositController
                          .withdrawTransition[index]['walletNumber'];

                  Timestamp timestamp =
                      depositController.withdrawTransition[index]['time'];
                  ...
                  final amount =
                      depositController.withdrawTransition[index]['amount'];
                                ...
                                FutureBuilder(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    if (snapshot.data == true) {
                                      ...
                                      return text(
                                        title: controller
                                            .withdrawTransition[index]['company']
                                            .toString()
                                            .substring(0, 4),
                                        size: 10,
                                ...
                                FutureBuilder(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    if (snapshot.data == true) {
                                      ...
                                      return text(
                                        title: controller
                                            .withdrawTransition[index]['walletName']
                                            .toString()
                                            .substring(0, 4),
                                        size: 10,
                                      ); // Fallback if SVG not found
